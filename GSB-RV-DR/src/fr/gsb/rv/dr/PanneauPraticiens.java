...
public class PanneauPraticiens extends Pane {
    ...
    private TableView<Praticien> tabPraticiens;
    ...
    public PanneauPraticiens() {
        ...
        tabPraticiens = new TableView<Praticien>();
        ...
        grid.getChildren().add(boutons);
        grid.getChildren().add(tabPraticiens);
    ...
    public void rafraichir() throws ConnexionException, SQLException{
        ...
        tabPraticiens.setItems(listeObs);
    }
